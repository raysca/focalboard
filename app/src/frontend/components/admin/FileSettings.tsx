...
export function FileSettings() {
    const { data: settings, isLoading } = useSettings('files')
    ...
    if (!settings || settings.length === 0) {
        return <div className="p-6">No file settings found</div>
    }

    return (
        <div className="max-w-2xl">
            <h2 className="text-2xl font-bold mb-6">File Settings</h2>
