...
export function PermissionSettings() {
    const { data: settings, isLoading } = useSettings('permissions')
    ...
    if (!settings || settings.length === 0) {
        return <div className="p-6">No permission settings found</div>
    }

    return (
        <div className="max-w-2xl">
            <h2 className="text-2xl font-bold mb-6">Permission Settings</h2>
